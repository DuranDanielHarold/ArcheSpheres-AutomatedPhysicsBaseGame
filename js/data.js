...
const DEF = {
  ...
  monk:       {label:'Monk',      weapon:'Quarterstaff',    ab:'100-Fist Nirvana',  color:'#c8a870',dark:'#7a5a28',rim:'#ffe0a0',out:'#3a2808',wcol:'#ffe0a0',wdrk:'#c8a040', mass:5,   spd:260, hp:360, om:11.0,dmg:1.4, arm:32,  magDef:18, rest:.76, reach:2.7, tipR:0.15, wt:'quarterstaff'},
  ...
  flagellant: {label:'Flagellant', weapon:'Knotted Scourge',ab:'Penitence',         color:'#4a1116',dark:'#210609',rim:'#d8b06a',out:'#120304',wcol:'#c49a62',wdrk:'#6b3020', mass:6,   spd:238, hp:150, om:6.8, dmg:1.2, arm:0,   magDef:0,  rest:.78, reach:3.2, tipR:0.18, wt:'knottedscourge'},
  ...
  spartan:   {label:'Spartan',   weapon:'Doru+Aspis',     ab:'Phalanx Thrust', color:'#5b1a16',dark:'#260807',rim:'#d24634',out:'#120302',wcol:'#d8b060',wdrk:'#7a4a20', mass:7,   spd:205, hp:360, om:2.6, dmg:2.2, arm:70,  magDef:20, rest:.58, reach:2.8, tipR:0.18, wt:'doruaspis'},
  gladiator: {label:'Gladiator', weapon:'Gladius+Net',    ab:"Arena's Verdict",color:'#b98152',dark:'#6b3f24',rim:'#f0c08a',out:'#2a1408',wcol:'#d8d0c0',wdrk:'#7a6048', mass:6,   spd:255, hp:180, om:6.5, dmg:4.8, arm:55,  magDef:18, rest:.78, reach:2.2, tipR:0.26, wt:'gladiusnet'},
  ...
  queen:     {label:'Queen',     weapon:'Regal Rapier',   ab:'Royal Invisibility',   color:'#b01872',dark:'#5b0838',rim:'#ff8bd1',out:'#220016',wcol:'#ffb8e6',wdrk:'#a02a70', mass:5,   spd:280, hp:260, om:6.0, dmg:1.8, arm:30,  magDef:20, rest:.82, reach:3.6, tipR:0.09, wt:'regalrapier'},
...
const CLASS_DESC = {
  ...
  queen:{ability:'Royal Invisibility (6 stacks) — Vanishes for 1s, becoming untargetable and nearly invisible without gaining stacks. On reappear, summons 3 randomized 1-HP Archer Allies that obey normal arena gravity and do not chase. Allies last 10s.',passive:"Courtly Menace — Nearby enemies lose damage and speed. Back hits permanently raise the Queen's damage."},
