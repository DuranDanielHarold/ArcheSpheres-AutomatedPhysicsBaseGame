...
const DEF = {
  ...
  queen:     {label:'Queen',     weapon:'Regal Rapier',   ab:'Royal Invisibility',   color:'#b01872',dark:'#5b0838',rim:'#ff8bd1',out:'#220016',wcol:'#ffb8e6',wdrk:'#a02a70', mass:5,   spd:280, hp:400, om:11.0,dmg:3.5, arm:75,  magDef:45, rest:.82, reach:3.6, tipR:0.09, wt:'regalrapier'},
...
const CLASS_DESC = {
  ...
  queen:{ability:'Royal Invisibility (6 stacks) — Vanishes for 1s, becoming untargetable and nearly invisible without gaining stacks. On reappear, summons 3 randomized Archer Allies that obey normal arena gravity and do not chase. Allies last 10s.',passive:"Courtly Menace — Nearby enemies lose damage and speed. Back hits permanently raise the Queen's damage."},
