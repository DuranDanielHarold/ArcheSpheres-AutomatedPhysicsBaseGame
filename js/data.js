...
const DEF = {
  knight:     {label:'Knight',    weapon:'Broadsword',      ab:'Shield Bubble',   color:'#b0bec8',dark:'#506878',rim:'#d8eaf8',out:'#334455',wcol:'#d0dce8',wdrk:'#88a0b0', mass:12,  spd:210, hp:500, om:4.5, dmg:3.2, arm:152, magDef:38, rest:.62, reach:3.2, tipR:0.22, wt:'broadsword'},
  ...
  viking:     {label:'Viking',    weapon:'Battle Axe',      ab:'Rage Spin',       color:'#3a5070',dark:'#1a2a40',rim:'#6080a8',out:'#102030',wcol:'#c8a030',wdrk:'#886010', mass:8.5, spd:220, hp:500, om:4.5, dmg:4.8, arm:120, magDef:35, rest:.66, reach:2.6, tipR:0.45, wt:'battleaxe'},
  ...
  paladin:    {label:'Paladin',   weapon:'Holy Morningstar',ab:'Sacred Wrath',    color:'#c0900a',dark:'#806000',rim:'#f0c040',out:'#503800',wcol:'#f0e090',wdrk:'#c0a040', mass:9,   spd:212, hp:500, om:4.0, dmg:3.8, arm:180, magDef:55, rest:.62, reach:2.8, tipR:0.40, wt:'morningstar'},
  ...
  wizard:     {label:'Wizard',    weapon:'Arcane Orb',      ab:'Rod Cycle',       color:'#4a0080',dark:'#2a0050',rim:'#cc88ff',out:'#1a0030',wcol:'#cc88ff',wdrk:'#884499', mass:5,   spd:180, hp:420, om:4.5, dmg:6.0, arm:70,  magDef:60, rest:.72, reach:2.8, tipR:0.30, wt:'orbstaff'},
  ...
  crusader:   {label:'Crusader',  weapon:'Flail+Shield',    ab:'Holy Charge',       color:'#c8b870',dark:'#806020',rim:'#fffacc',out:'#403010',wcol:'#fffacc',wdrk:'#c8a040', mass:11,  spd:205, hp:540, om:4.0, dmg:4.0, arm:165, magDef:52, rest:.58, reach:2.5, tipR:0.40, wt:'flailshield'},
