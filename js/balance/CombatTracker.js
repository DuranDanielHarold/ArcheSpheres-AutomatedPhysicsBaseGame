...
class CombatTracker{
 ...
 getSummary(){
  ...
  const sideSummary=side=>{const d=this._dmg[side],total=d.base+d.ability+d.passive+d.dot+d.projectile,dur=this._matchDuration||1,r=this._rotation[side],a=this._ability[side],p=this._passive[side],pr=this._proj[side];return{
